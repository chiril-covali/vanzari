...
app.get('/triggerCelebration', (req, res) => {
  // Opțional, poți prelua parametrii din query: managerId, amount, etc.
  const { managerId, amount } = req.query;
  // Emite un eveniment către toți clienții pentru a declanșa celebrarea
  io.emit('newDataFetched', { managerId, amount });
